...
(defn -main [& $beagle$rest$host]
  ...
  (println "WITHDRAWAL           at=" (occurrence-label (t/operationoccurrence-coordinate (t/withdrawal-retraction withdrawal))) " withdraws=" (occurrence-label (t/operationoccurrence-coordinate (t/withdrawal-assertion withdrawal))) "  (the retraction that supersedes the old assertion)")
  (println)
  ...
  (println "=> old red assertion EXISTS, marked not-live; new crimson assertion is live; same node. Supersession is real:" (and (some? (assertion-occurrence-of occurrences old-proposition)) (not (live-occurrence? ctx old-occurrence)) (live-occurrence? ctx new-occurrence) (= (t/triple-t1 old-proposition) (t/triple-t1 new-proposition)))))))
