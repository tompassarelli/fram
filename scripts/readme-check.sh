...
# (1) stale repo URLs — wrong org/repo forms. (tompassarelli/lodestar is CORRECT; not listed.)
echo "== (1) repo URLs =="
BANNED='tompassarelli/(fram|beagle|eddy|chartroom)|Autonymy/(lodestar|eddy|chartroom)'
