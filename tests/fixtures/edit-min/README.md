...
- Source bytes (`~/code/fram/main/src/fram/schema.bclj`):
  `fc7b319b95bb421e8ff10888c19bde2872b96e177f3e44afe0844718d6800016`
- Fixture bytes (`~/code/fram/main/tests/fixtures/edit-min/schema.code.factlog`):
...
```sh
cd ~/code/fram/main
bb -cp ~/code/fram/main/out ~/code/fram/main/bin/fram-ingest-code src/fram/schema.bclj \
  --module schema \
  --out ~/code/fram/main/tests/fixtures/edit-min/schema.code.factlog
```
