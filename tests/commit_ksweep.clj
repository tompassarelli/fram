;; ============================================================================
;; commit_ksweep.clj — System 3: gate cost vs corpus size K, decomposed
;;   bb -cp out commit_ksweep.clj <corpus-log-path>
;;
...
;; folded into the other (the materialization-vs-commit-sequencer confound flag).
...
;; code, never to gate) — so commit-sequencer here is pure-graph, no Clojure materialization.
;;
