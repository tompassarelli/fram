;; ============================================================================
;; commit_crdt_insert_receipt.clj — #36 the bar: concurrent MIDDLE-INSERTS commute
;;   bb -cp out commit_crdt_insert_receipt.clj
;;
...
(def tmp (str "/tmp/store-crdt-" (System/nanoTime) ".log"))
