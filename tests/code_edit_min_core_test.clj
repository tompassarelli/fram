;; ============================================================================
;; code_edit_min_core_test.clj — IN-PROCESS green-core proof for the minimal-op
...
;;   bb -cp out code_edit_min_core_test.clj
;;
...
;; (tests/code_edit_min_rename.clj is the render+recompile receipt). This is the #25-LOCK
