;; ============================================================================
;; database_sim.clj — #11 R2 (continuous arrival) + R3 (failure-heavy).
;; *** SIMULATION — LABELED. *** Real CI x the full arrival-rate x CI-duration sweep is
;; infeasible, so this is a discrete-event sim of the two database PROTOCOLS. The
...
;; commit_experiment.clj, 2 runs 3912/3848ms); the others bracket it (modeled, swept).
