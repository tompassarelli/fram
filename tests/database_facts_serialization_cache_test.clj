...
;; request.  Run:
;;   bb -cp out tests/database_facts_serialization_cache_test.clj
;;
...
;; thrashes. The wedged database found on 2026-07-29 was 20.5 GB RSS, old gen
...
(let [failures (remove second @checks)]
  ...
  (if (seq failures)
    (do (println "\ndatabase-facts-serialization-cache:" (count failures) "FAILED")
        (System/exit 1))
    (println "\ndatabase-facts-serialization-cache:"
