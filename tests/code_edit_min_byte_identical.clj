;; ============================================================================
;; code_edit_min_byte_identical.clj — CORRECTNESS (non-negotiable):
...
;;   bb -cp out code_edit_min_byte_identical.clj
;; ============================================================================
...
(defn- fail-fast! [& xs]
  ...
  (System/exit 1))
(doseq [p [fixture source-path beagle-bin]]
...
;; positional input to fram-commit-code against a disposable server. Rendering
