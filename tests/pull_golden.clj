...
;; ---------------------------------------------------------------------------
;; PART 2 — run over a real store built through the coord API.
;; ---------------------------------------------------------------------------
...
(register-pred! co "rel" "multi" "ref")
...
(commit! co "u" "@dep1" "depends_on" :link "@dep2" nil)
(commit! co "u" "@dep2" "title" :assert "Deep" nil)
(commit! co "u" "@a" "part_of" :link "@x" nil)
...
(commit! co "u" "@c4" "rel" :link "@c5" nil)
(commit! co "u" "@k1" "rel" :link "@k2" nil)
(commit! co "u" "@k2" "rel" :link "@k1" nil)
(def s1 (:ok (commit! co "u" "@y" "status" :assert "s1" nil)))
(def s2 (:ok (commit! co "u" "@y" "status" :assert "s2" nil)))
(def st-t (:ok (commit! co "u" "@y" "tag" :assert "T" nil)))
(retract! co "u" "@y" "tag" "T" nil)
