;; commit_fenced_write_test.clj — real-socket proof that lease validation and a
;; fact mutation share one commit sequencer turn. A stale holder must never mutate
;; after release, expiry, or takeover.
;;
;; Run: bb -cp out tests/commit_fenced_write_test.clj
