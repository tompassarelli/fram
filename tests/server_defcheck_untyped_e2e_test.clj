;; ============================================================================
;; server_defcheck_untyped_e2e_test.clj — UNTYPED def-check e2e through write-def.
;; ============================================================================
;; Ingests a REAL untyped Clojure module (ring-core ring.middleware.cookies at the
;; ring-06 C0) into a scratch code server, boots it with FRAM_DEFCHECK=1, and
...
;;
;; Scratch-only: server on a port >=49010, and the warm renderer sidecar on a
...
;;
;;   FRAM_DEFCHECK=1 clojure -M tests/server_defcheck_untyped_e2e_test.clj ; echo EXIT=$?
;; ============================================================================
...
;; --- boot a scratch code server with FRAM_DEFCHECK=1 --------------------
...
(cond
  ...
  :else
  (do
    (println "untyped def-check LIVE — database" port "sidecar" sidecar-port "\n")
