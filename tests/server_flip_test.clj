;; server_flip_test.clj — Stage 7 cutover-mechanism gate: the WHOLE flip, proven on a
...
(def before-reif (domain-triples (:store @db)))
...
(def after-reif (domain-triples (:store @db)))
