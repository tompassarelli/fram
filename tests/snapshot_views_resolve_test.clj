;; snapshot_views_resolve_test.clj — thread E, read-layer half: select-main-1 is now
...
;;
;; Companion to snapshot_honesty_pass_test (which proves the *view*=nil default ≡ first):
;; this proves a BOUND `*view*` isolates a branch's line, and silence inherits main.
;;   bb -cp out tests/snapshot_views_resolve_test.clj
