...
;; (add-def / set-body / rename-def) are recompile-gated FACT operations on a
;; graph-owned Beagle module — NOT text splices — and that they FAIL CLOSED.
;;
...
;;   (b) GOOD add-def edit -> a new top-level def is PRESENT + recompiles (fact op:
