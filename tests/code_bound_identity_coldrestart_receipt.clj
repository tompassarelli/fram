;; ============================================================================
;; code_bound_identity_coldrestart_receipt.clj — #(a) rename + render survive a COLD
;; RESTART by IDENTITY, with no spelling fallback for already-resolved references.
;;   bb -cp out code_bound_identity_coldrestart_receipt.clj
;;
;; The core hazard (code_rename_spelling_check): a graph rename edits ONLY the def
