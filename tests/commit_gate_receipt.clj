;; ============================================================================
;; commit_gate_receipt.clj — System 1 part 2 (coupling guard) + System 2 gate-core
;;   bb -cp out commit_gate_receipt.clj
;;
...
(def tmp (str "/tmp/store-gate-rcpt-" (System/nanoTime) ".log"))
