;; ============================================================================
;; code_edit_min_commute.clj — GATE 2 (THE MAKE-OR-BREAK): two edits to DIFFERENT
;; defns in the SAME module COMMUTE through ONE warm server.
;; ============================================================================
...
;; both edits go through the SAME warm server. Each :edit-min clones the live
...
;; other. Both are then accepted, in order, by one server over another pristine
